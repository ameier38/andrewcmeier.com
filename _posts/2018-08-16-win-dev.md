...
updated: 2018-12-31 7:00:00 -0400
categories: 
  - windows
  - development
comments: true
...
### Installation
Install Docker Desktop. For Windows you can download 
...
```
> This also installs `docker-compose`.
...
You can install local, single-node cluster using Docker.

### Installation

1. Install Docker. (See [Docker instructions](#docker) for more information)
...
### Usage
To take a screen shot by pressing the `PrtScr` button
on your keyboard. You can then select an area on your screen,
add lines or arrows, and then save or copy the image
to your clipboard.
